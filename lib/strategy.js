...
function WechatEnterpriseStrategy(options, verify, getAccessToken, saveAccessToken) {
  ...
  if (!options.agentId) {
    throw new Error('WechatEnterpriseStrategy requires a agentId option')
  }
...
WechatEnterpriseStrategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    var location = (this._client === 'wechat') ? this._oauth.getAuthorizeUrl(params) : this._oauth.getAuthorizeURLForWebsite(params)
