...
const AuthorizeUrlWebsite = 'https://open.work.weixin.qq.com/wwopen/sso/qrConnect'
...
OAuth.prototype.getAuthorizeURLForWebsite = function(options) {
  ...
  params['redirect_uri'] = options.redirect_uri
  params['agentid'] = this._agentId
  params['state'] = options.state || 'web_login'
  return AuthorizeUrlWebsite + '?' + querystring.stringify(params)
}
